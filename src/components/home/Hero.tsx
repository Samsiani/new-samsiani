...
export function Hero() {
  ...
  return (
    ...
    >
      {/* Scattered decorative elements — static */}
      ...
      <motion.div style={{ opacity, y }} className="relative z-10 mx-auto max-w-5xl text-center">
        ...
        {/* Main heading — word by word, clean fade-up */}
        ...
        >
          ...
          <span className="inline-block font-semibold text-[var(--c-fg)]">იყიდის</span>{" "}
          და{" "}
          <span className="inline-block font-semibold text-[var(--c-accent)]">ახარებს</span>
          .
        </motion.p>
